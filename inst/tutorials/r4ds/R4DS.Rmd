...
__Remark:__ A version of this file is available online and you should use this version and not your local version.

```{r exercise-26, exercise=TRUE, exercise.eval = TRUE}
# adjust/complete the following code to get a proper output
read_csv("https://syncandshare.lrz.de/getlink/fi2wRnXJjN9Qjx8wFkhRQ3/nyc_citibike_short.csv")
```
